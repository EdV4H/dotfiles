...
local ui_options = {
  ...
  scrolloff = 3, -- Always have top and bottom margins when scrolling
  cmdheight = 1, -- Lines of bottom commandline area
...
if vim.loop.os_uname().sysname == 'Darwin' then apply_options(mac_options) end
